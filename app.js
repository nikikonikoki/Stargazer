...
app.get('/our-solar-system/sun',full_sunController.index)
app.get('/our-solar-system/mercury',full_mercuryController.index)
app.get('/our-solar-system/venus',full_venusController.index)
app.get('/our-solar-system/earth',full_earthController.index)
app.get('/our-solar-system/mars',full_marsController.index)
app.get('/our-solar-system/jupiter',full_jupiterController.index)
app.get('/our-solar-system/saturn',full_saturnController.index)
app.get('/our-solar-system/uranus',full_uranusController.index)
app.get('/our-solar-system/neptune',full_neptuneController.index)
